...
public class XmlManager {
    ...
    public static void main(String[] args) {
        ...
        try {
            Map<String, Object> parsedMap = (Map<String, Object>) parser.XMLparse(file).get("saved_workspace");
            ...
            Map<String, Map<String, String>> colorStorage =
                    (Map<String, Map<String, String>>) parsedMap.get(myResources.getString("color_storage"));
            fakeStorageManager.setColorStorage(dataSetter.setColors(colorStorage));


            Map<String, Map<String, String>> commandStorage =
                    (Map<String, Map<String, String>>) parsedMap.get(myResources.getString("function_storage"));
            fakeStorageManager.setCommandVariableStorage(dataSetter.setCommandVariables(commandStorage));


            Map<String, Map<String, String>> variableStorage =
                    (Map<String, Map<String, String>>) parsedMap.get(myResources.getString("variable_storage"));
            fakeStorageManager.setValueVariableStorage(dataSetter.setValueVariables(variableStorage));


            Map<String, Map<String, String>> turtleStorage =
                    (Map<String, Map<String, String>>) parsedMap.get(myResources.getString("turtle_storage"));
